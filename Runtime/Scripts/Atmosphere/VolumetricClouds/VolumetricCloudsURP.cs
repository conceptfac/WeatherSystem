...
public class VolumetricCloudsURP : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        var stack = volumeManager != null ? volumeManager.stack : null;
        VolumetricClouds cloudsVolume = stack != null ? stack.GetComponent<VolumetricClouds>() : null;
        ColorAdjustments colorAdjustments = stack != null ? stack.GetComponent<ColorAdjustments>() : null;
        bool isDebugger = DebugManager.instance != null && DebugManager.instance.isAnyDebugUIActive;
        bool isVolumeActive = cloudsVolume != null && cloudsVolume.IsActive() && (!isDebugger || renderingDebugger);
    ...
    public class VolumetricCloudsPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            if (outputDepth)
            {
                RTHandle[] colorAndDepthTargets = { cloudsColorHandle, cloudsDepthHandle };

                // RT-1: clouds lighting
                // RT-2: clouds depth
                ConfigureTarget(colorAndDepthTargets, cloudsColorHandle);
            }
            else
            {
